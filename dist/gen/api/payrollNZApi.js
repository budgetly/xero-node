...
class PayrollNzApi {
     ...
     * @param page Page number which specifies the set of records to retrieve. By default the number of the records per set is 100.
     */
    getEmployees(xeroTenantId, firstName, lastName, page, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/Employees';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     */
    getTimesheets(xeroTenantId, page, employeeId, payrollCalendarId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/Timesheets';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
            ...
            if (employeeId !== undefined) {
                localVarQueryParameters['employeeId'] = models_1.ObjectSerializer.serialize(employeeId, "string");
            }
            if (payrollCalendarId !== undefined) {
                localVarQueryParameters['payrollCalendarId'] = models_1.ObjectSerializer.serialize(payrollCalendarId, "string");
            }
            localVarHeaderParams['Xero-Tenant-Id'] = models_1.ObjectSerializer.serialize(xeroTenantId, "string");
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
