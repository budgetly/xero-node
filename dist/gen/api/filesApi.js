...
class FilesApi {
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "FileResponse204");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     * @param mimeType
     */
    uploadFile(xeroTenantId, folderId, body, name, filename, mimeType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/Files';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
            ...
            if (folderId !== undefined) {
                localVarQueryParameters['folderId'] = models_1.ObjectSerializer.serialize(folderId, "string");
            }
            localVarHeaderParams['xero-tenant-id'] = models_1.ObjectSerializer.serialize(xeroTenantId, "string");
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            if (body !== undefined) {
                localVarFormParams['body'] = models_1.ObjectSerializer.serialize(body, "string");
            }
            if (name !== undefined) {
            ...
            if (mimeType !== undefined) {
                localVarFormParams['mimeType'] = models_1.ObjectSerializer.serialize(mimeType, "string");
            }
            let localVarRequestOptions = {
                method: 'POST',
                qs: localVarQueryParameters,
            ...
            localVarFormParams[name] = models_1.ObjectSerializer.serialize(body, "string");
            let authenticationPromise = Promise.resolve();
            authenticationPromise = authenticationPromise.then(() => this.authentications.OAuth2.applyToRequest(localVarRequestOptions));
            authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(localVarRequestOptions));
            return authenticationPromise.then(() => {
