...
export declare class AssetApi {
     ...
     */
    getAssets(xeroTenantId: string, status: AssetStatusQueryParam, page?: number, pageSize?: number, orderBy?: 'AssetType' | 'AssetName' | 'AssetNumber' | 'PurchaseDate' | 'PurchasePrice' | 'DisposalDate' | 'DisposalPrice', sortDirection?: 'asc' | 'desc', filterBy?: 'AssetName' | 'AssetNumber' | 'Description' | 'AssetTypeName', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
